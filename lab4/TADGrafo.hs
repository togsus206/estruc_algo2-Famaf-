...
hay_caminoG v w (Arista a b g) |v==a = w==b ||v==w || hay_caminoG v w g || hay_caminoG b w g
                               |otherwise = (hay_caminoG v a g && hay_caminoG b w g) || hay_caminoG v w g|| v==w && está_vérticeG v (Arista a b g)
